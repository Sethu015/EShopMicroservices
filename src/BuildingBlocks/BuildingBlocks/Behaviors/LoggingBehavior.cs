...
namespace BuildingBlocks.Behaviors
{
        ...
        where TResponse : notnull
    {
        ...
        {
            logger.LogInformation("[Start] Handle request {request} - response {response} with request {requestObject}", typeof(TRequest).Name
            ...
            {
                logger.LogWarning("[Performance] The request {request} took {seconds} seconds", typeof(TRequest).Name, timeTaken.Seconds);
            }
